...
INSERT
INTO thread (id, author_username, title, topic_id,anonymous)
VALUES (1, 'orga1', 'Klausurtermine', 1,FALSE),
       (2, 'studentin1', 'Praktikum: Informationen', 1,FALSE),
       (3, 'orga2', 'Organisation / Austausch', 1,FALSE),
       (4, 'studentin', 'Tutorenjobs im WS 2020', 1,FALSE),
       (5, 'orga1', 'Kommt zum Hackathon !', 1,FALSE),
       (6, 'studentin', 'Ich brauche Hilfe bei Aufgabe 4a', 2,TRUE),
       (7, 'orga2', 'Was ist eine IDE ?', 2,TRUE),
       (8, 'studentin3', 'Docker Compose funktioniert nicht :(', 2,TRUE),
       (9, 'orga', 'Ich will lieber Germanistik studieren', 2,TRUE),
       (10, 'orga', 'Was ist Hibernate ?', 2,TRUE);
